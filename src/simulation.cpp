...
void simulation::simulate()
{
    ...
    while(true){
        ...
        trajGen.FuncPoly3rd(t, 15.0, 18.0, 0.0, 0.0, 3, 0.0);
        ...
        wheelyBotRobot.stateVec_des << 0, tP, 0, 0, trajGen.trajOut(0), 0;
        ...
        commandTau << wheelyBotRobot.tauJointPD(0), wheelyBotRobot.tauJointPD(1), wheelyBotRobot.wheelTorques(0), 
                      wheelyBotRobot.tauJointPD(2), wheelyBotRobot.tauJointPD(3), wheelyBotRobot.wheelTorques(1);
